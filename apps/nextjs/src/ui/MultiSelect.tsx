...
import { Command, CommandGroup, CommandItem } from "./Commang";
...
export function MultiSelect({
  ...
  return (
    ...
    >
      <div className="group rounded-md border border-input px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 dark:border-slate-6 dark:bg-slate-3">
      ...
      <div className="relative z-50 mt-2">
        {isOpen && filteredOptions.length > 0 ? (
          <div className="absolute top-0 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in dark:border-slate-6">
